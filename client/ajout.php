...
<head>
    ...
    <!-- Icons font CSS-->
    <link href="vndor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">
    ...
    <!-- Main CSS-->
    <link href="ajout.css" rel="stylesheet" media="all">
</head>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Information Client</h2>
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Sex" name="sex">
                        </div>
                        <div class="input-group">
